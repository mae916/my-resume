      ...
      <section className="flex justify-center w-full py-20">
        <div>
          <Image
            src={profileImg}
            alt="내 프로필 이미지"
            className="w-[520px] h-[570px] object-cover object-bottom overflow-hidden shadow-xl rounded-4xl "
          />
        </div>
        <div className="flex flex-col ml-20 justify-evenly w-[70%]">
          <div>
            ...
            <p className="mt-10 break-keep">
              단순히 작동하는 기능보다, "왜 이렇게 동작해야 하는가", "이 방식이
              사용자에게 더 나은가"를 먼저 고민합니다. <br />
              또한, 업무 중 마주친 문제는 그대로 넘기지 않고, 주말이나 퇴근
              후에라도 다시 복기하고 분석하는 습관을 갖고 있습니다.
              <br /> 이런 태도가 쌓여 단순히 구현하는 사람이 아닌, 사용자와
              서비스의 흐름을 함께 설계하는 개발자로 성장하고 있다고 믿습니다.
            </p>
          </div>
