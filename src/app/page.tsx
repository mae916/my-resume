  ...
  return (
    <section className="flex flex-col justify-center w-full py-20 lg:flex-row">
      <p className="inline-block mb-10 text-3xl font-medium leading-normal text-center lg:hidden">
        ...
        <span className="underline text-accent underline-offset-8">김혜진</span>
        &nbsp;입니다.
      </p>
      <div>
        <Image
      ...
      <div className="flex flex-col lg:ml-20 justify-evenly w-[95%] lg:w-[75%] mx-auto text-center mt-10 lg:mt-0 lg:text-left">
        <div>
          <h1 className="hidden text-3xl font-medium leading-normal lg:leading-relaxed lg:text-4xl lg:inline-block">
            기능보다 이유를 먼저 묻는,
            <br /> 프론트엔드 개발자&nbsp;
          ...
          <p className="mb-3 lg:mt-10 lg:mb-0">
            ...
            <br />
            이 방식이 사용자에게 <br className="block lg:hidden" /> 더 나은가를
            먼저 고민합니다. <br />
            또한, 업무 중 마주친 문제는
            <br className="block lg:hidden" />
            &nbsp;그대로 넘기지 않고,&nbsp;
        ...
        <ul
          className="flex flex-wrap justify-center gap-2 mt-5 mb-10 lg:mt-0 lg:justify-start"
          aria-label="특징 해시태그"
        >
          {hashTags.map((tag) => (
            <li
        ...
        <div className="flex items-center justify-center text-lg lg:justify-start">
          <a
            ...
            {...externalLinkProps}
            className="bg-primary text-[var(--background)] rounded-full h-full px-5 py-3 mr-5 hover:bg-accent hover:border-primary transition-colors"
